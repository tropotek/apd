...
class Manager extends AdminManagerIface
{
    ...
    public function doDefault(Request $request)
    {
        ...
        $this->setTable(\App\Table\InvoiceItem::create());
        $this->getTable()->setEditUrl(\Bs\Uri::createHomeUrl('/invoiceItemEdit.html')->set('pathCaseId', (int)$request->get('pathCaseId')));
        $this->getTable()->init();

        $filter = array(
            'pathCaseId' => (int)$request->get('pathCaseId')
        );
