 ...
 */
class Specimens extends \Uni\Controller\AdminIface
{
    ...
    {
        $this->setPageTitle('Stored Specimens');
    ...
    {
        $this->cmsPanel = CmsPanel::create('Stored Specimens', 'fa fa-archive', 'inst.cms.specimens');
