 ...
 */
class Test extends \Bs\TableIface
{
    ...
    public function init()
    {
        ...
        // Actions
        //$this->appendAction(\Tk\Table\Action\Link::createLink('New Test', \Bs\Uri::createHomeUrl('/testEdit.html'), 'fa fa-plus'));
     ...
     * @return \Tk\Db\Map\ArrayObject|\App\Db\Test[]
     * @throws \Exception
     */
    public function findList($filter = [], $tool = null)
    {
        ...
        $list = \App\Db\TestMap::create()->findFiltered($filter, $tool);
        return $list;
    }
